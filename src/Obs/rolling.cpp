...
void Rolling::_log_ridge_S(const Vals curr)
{
    ...
    if (curr.energy == S_last_energy)
    {
        S_e_same.mu1 = iterative_mean(S_e_same.mu0,
            E_current_ridge, S_e_same.counter);
        S_e_same.S1 = iterative_S(S_e_same.mu0, S_e_same.mu1, E_current_ridge,
            S_e_same.S0);
    ...
    else
    {
        S_e_diff.mu1 = iterative_mean(S_e_diff.mu0,
            E_current_ridge, S_e_diff.counter);
        S_e_diff.S1 = iterative_S(S_e_diff.mu0, S_e_diff.mu1, E_current_ridge,
            S_e_diff.S0);
